  ...
  try {
    ...
    const response = await fetch("https://ai.gateway.lovable.dev/v1/chat/completions", {
      ...
      body: JSON.stringify({
        ...
        messages: [
          { role: "system", content: "You are a helpful AI assistant for Modenik Lifestyle, an innerwear and apparel company. You help with product queries, order status, design workflows, production tracking, marketing campaigns, and business analytics. Keep answers concise and relevant to the textile/apparel industry. Use INR for currency." },
          ...messages,
        ],
        stream: true,
      }),
